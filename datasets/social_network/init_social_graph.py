...
if __name__ == '__main__':
  ...
  with open(os.path.join('datasets/social_network/social-graph', args.graph, f'{args.graph}.nodes'), 'r') as f:
    nodes = getNumNodes(f)
  with open(os.path.join('datasets/social_network/social-graph', args.graph, f'{args.graph}.edges'), 'r') as f:
    edges = getEdges(f)
